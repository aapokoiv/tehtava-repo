...
def get_season():
    ...
    while True:
        season = input("Season: [2018-19/2019-20/2020-21/2021-22/2022-23/2023-24/2024-25/2025-26] ").strip()
...
def get_nation():
    ...
    while True:
        nation = input("Nationality: [USA/FIN/CAN/SWE/CZE/RUS/SLO/FRA/GBR/SVK/DEN/NED/AUT/BLR/GER/SUI/NOR/UZB/LAT/AUS] ").strip().upper()
